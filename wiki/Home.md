...
| 구분 | 문서 |
| --- | --- |
| 프로젝트 | [프로젝트 개요](01-project.md) · [요구사항 및 제약](02-requirements.md) · [전체 아키텍처](03-architecture.md) |
| 기획 | [문제 정의 및 사용 흐름](04-planning.md) |
| 기술 | [AI 분석 파이프라인](05-ai-pipeline.md) · [URL 보안 분석](06-url-analysis.md) · [API 명세](07-api.md) · [데이터베이스 구조](08-data-model.md) |
| 모델·검증 | [모델 및 평가](09-model-evaluation.md) · [검증 프로세스](12-validation.md) |
| 운영 | [실행 및 운영](10-operations.md) · [보안 및 개인정보](11-security.md) · [피드백 개선](13-feedback.md) |
